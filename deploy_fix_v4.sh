#!/bin/bash
# Deployment script for WhisperLiveKit with improved audio processing fix v4

echo "================================================"
echo "WhisperLiveKit Improved Audio Processing Fix v4 Deployment"
echo "================================================"
...
# - --min-chunk-size 0.2: Process smaller audio chunks (200ms instead of 500ms)
echo "Starting server with improved audio processing fix..."
